...
<html>
  ...
  <body bgcolor="#FFFFFF" link="#355222" alink="#355222" vlink="#355222" style="font-family: Verdana, Geneva, Arial, Helvetica, sans-serif; font-size: 14px;">
    <br>
    ...
    <tr>
      <td style="font-family: Verdana, Geneva, Arial, Helvetica, sans-serif; font-size: 14px; background-color: #494949; color: #FFFFFF;" align="right" width="70">
        <b>[{ oxmultilang ident="EMAIL_SENDEDNOW_HTML_QUANTITY" }]</b>
      </td>
      <td style="font-family: Verdana, Geneva, Arial, Helvetica, sans-serif; font-size: 14px; background-color: #494949; color: #FFFFFF;" height="15" width="100">
        &nbsp;&nbsp;<b>[{ oxmultilang ident="EMAIL_SENDEDNOW_HTML_PRODUCT" }]</b>
      </td>
      [{if $blShowReviewLink}]
      <td style="font-family: Verdana, Geneva, Arial, Helvetica, sans-serif; font-size: 14px; background-color: #494949; color: #FFFFFF;" align="right" width="150">
    ...
    [{foreach from=$order->getOrderArticles(true) item=oOrderArticle}]
      <tr>
        <td style="font-family: Verdana, Geneva, Arial, Helvetica, sans-serif; font-size: 14px; padding-top: 10px;" valign="top" align="right">
          [{ $oOrderArticle->oxorderarticles__oxamount->value }]
        </td>
        <td valign="top" style="font-family: Verdana, Geneva, Arial, Helvetica, sans-serif; font-size: 14px; padding-top: 10px;">
        ...
        [{if $blShowReviewLink}]
        <td style="font-family: Verdana, Geneva, Arial, Helvetica, sans-serif; font-size: 14px; padding-top: 10px;" valign="top" align="right">
          <a href="[{ $oViewConf->getBaseDir() }]index.php?shp=[{$shop->oxshops__oxid->value}]&amp;anid=[{ $oOrderArticle->oxorderarticles__oxartid->value }]&amp;cl=review&amp;reviewuserhash=[{$reviewuserhash}]" style="font-family: Verdana, Geneva, Arial, Helvetica, sans-serif; font-size: 14px;" target="_blank">[{ oxmultilang ident="EMAIL_SENDEDNOW_HTML_REVIEW" }]</a>
        </td>
        [{/if}]
      </tr>
    [{/foreach}]
    ...
    [{if $order->getShipmentTrackingUrl()}]
        [{ oxmultilang ident="EMAIL_SENDEDNOW_HTML_SHIPMENTTRACKING" }]<br/>
