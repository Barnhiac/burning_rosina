...
<div style="width: 650px; margin: 0 auto;font-family: Verdana, Geneva, Arial, Helvetica, sans-serif; font-size: 10px;">
...
<br/>
<p>    <b>[{ oxmultilang ident="EMAIL_ORDER_CUST_HTML_ORDERNOMBER" }] [{ $order->oxorder__oxordernr->value }]</b><br>
</p>
        </div>
...
<table style="padding-right: 50px; vertical-align: top;font-family: Verdana, Geneva, Arial, Helvetica, sans-serif; font-size: 10px;">
    ...
    <tr><td><b>[{ oxmultilang ident="EMAIL_ORDER_CUST_HTML_ORDERNOMBER" }]</b></td><td>[{ $order->oxorder__oxordernr->value }]</b></td>
...
[{if $payment->oxuserpayments__oxpaymentsid->value != "oxempty"}]<tr><td><b>[{ oxmultilang ident="EMAIL_ORDER_OWNER_HTML_PAYMENTINFO" }]</b></td><td>
    [{ oxmultilang ident="EMAIL_ORDER_CUST_HTML_PAYMENTMETHOD" }] [{ $payment->oxpayments__oxdesc->value }] [{ if $basket->getPaymentCosts() }]([{ $basket->getFPaymentCosts() }] [{ $currency->sign}])</td></tr>[{/if}]
    ...
    [{if $payment->oxuserpayments__oxpaymentsid->value != "oxempty"}]<tr><td><b>[{ oxmultilang ident="EMAIL_ORDER_CUST_HTML_SHIPPINGCARRIER" }]</b></td><td>[{ $oDelSet->oxdeliveryset__oxtitle->value }]</strong></td></tr>[{/if}]
...
<tr>
    ...
    <td>[{ oxmultilang ident="THD_KONTO_10" }] [{ $order->oxorder__oxordernr->value }]</td>
</tr>
<tr>
    <td>[{ oxmultilang ident="THD_KONTO_11" }]</td>
    <td>[{ oxmultilang ident="THD_KONTO_12" }]</td>
</tr>
<tr>
