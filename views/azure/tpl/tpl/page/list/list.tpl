                           ...
                           <!-- <div class="box"> -->
                                ...
                                [{else}]
                                    <!-- <div class="content catPicOnly"> -->
                                        ...
                                        [{if $iconUrl}]
                                        <li class = "topmenu">
                                            <a class = "topmenulink" href="[{ $category->getLink() }]"><div class = "imageContainer"><img src="[{$category->getIconUrl() }]" alt="[{ $category->oxcategories__oxtitle->value }]"></div><div class = "text">[{ $category->oxcategories__oxtitle->value }]</div>
