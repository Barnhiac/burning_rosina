[{block name="widget_product_listitem_grid"}]
    ...
    <div class = "productName"><a href = "[{$_productLink}]">[{ $product->oxarticles__oxtitle->value }] [{$product->oxarticles__oxvarselect->value}]</a></div>
        ...
        <div class="priceBlock">
            [{oxhasrights ident="TOBASKET"}]
                ...
                [{else}]
                    ...
                    <div class = "infoBlock">  
                    <a class = "toProduct" href = "[{$_productLink}]">[{ oxmultilang ident="MORE_INFO" }]</a>
