...
<div class="detailsInfo clear">
    ...
    <div class="information">
        ...
        <div class="productMainInfo[{if $oManufacturer->oxmanufacturers__oxicon->value}] hasBrand[{/if}]">
            ...
            [{block name = "longdesc_productmain"}]
    ...
    <div class="tobasket">
            ...
            [{block name="details_productmain_watchlist"}]
            [{/block}]
            ...
            <div class="tobasketFunction clear">
                ...
                [{block name="details_productmain_tobasket"}]
                    [{oxhasrights ident="TOBASKET"}]
                        [{assign var = "productVars" value = $oDetailsProduct->getFullVariants()}]
                        [{if !$oDetailsProduct->isNotBuyable() && !$productVars}]
                            <div class = "amount">
                                    <div class = "quantity">
                                    ...
                                    <div class = "price place">
                                        <div class = "productTitleLower">
                                            <h4 class = "lowerTitle">[{$oDetailsProduct->oxarticles__oxtitle->value}]</h4>
                                           [{assign var="sSelectionSep" value=""}]
                                            <h4 class = "variantSubTitle">
                                                [{strip}]
                                ...
                                [{if $oDetailsProduct->isVariant()}]
                                    ...
                                    <div class="variantReset"> 
                                        <a href="[{$parentArticle->getStdLink()}]" class="reset">&#10094;&nbsp;&nbsp;[{oxmultilang ident="INC_PRODUCT_VARIANTS_BACKTOMAINPRODUCT"}] [{$parentArticle->oxarticles__oxtitle->value}]</a>
                                    </div>
                                [{/if}]
                                [{assign var = "otherVariants" value = $oView->getVariantListExceptCurrent()}]
                                    [{if $otherVariants|@count gt 0}]
                                    <div class = "picture-variant-list">
                                        <h4 class="variant">[{ oxmultilang ident="INC_PRODUCT_VARIANTS_OTHERVARIANTSOF" }] [{ $parentArticle->oxarticles__oxtitle->value }]</h4>
                                    [{foreach from=$oView->getVariantListExceptCurrent() name=variants item=variant_product}]
                                        <div class = "variant">
                                        <div class = "variantPictures variantSection">
                                             <a class="variant-link" href="[{$variant_product->getMainLink()}]"> 
                                                <img class="variant-image img-responsive" src="[{$variant_product->getThumbnailUrl()}]"/> 
                                            </a>
                                        </div> 
                                        <div class = "variantTitle variantSection">
                                            <a class="variant-link" href="[{$variant_product->getMainLink()}]"> 
                                                <h1 class = "variantMainTitle">[{$parentArticle->oxarticles__oxtitle->value}]</h1>
                                                <h4 class = "variantSubTitle">[{$variant_product->oxarticles__oxvarselect->value}]</h4>
                                            </a>
                                        </div>
                                        <div class = "variantCost variantSection">
                                            <h4 class = "variantPrice">
                                                [{assign var="oPrice" value=$variant_product->getPrice()}]
                                ...
                                <div id="variants" class="selectorsBox js-fnSubmit clear">
                                    ...
                                    [{assign var="variants" value=$product->getFullVariants()}] 
                                    ...
                                    <div class="picture-variant-list"> 
                                        ...
                                        <div class = "variant"> 
                                            ...
                                            <div class = "variantTitle variantSection">
                                                <a class="variant-link" href="[{$variant->getMainLink()}]"> 
                                                    <h1 class = "variantMainTitle">[{$product->oxarticles__oxtitle->value}]</h1>
                                                    <h4 class = "variantSubTitle">[{$variant->oxarticles__oxvarselect->value}]</h4>
                                                 </a>
                                            </div>
                                            <div class = "variantCost variantSection">
                                                <h4 class = "variantPrice">
                                                [{assign var="oPrice" value=$variant->getPrice()}]
                                                [{oxprice price=$oPrice currency=$currency}]
                                                </h4>
                                                <a class="variant-link" href="[{$variant->getMainLink()}]"> 
                                                     [{ oxmultilang ident="MORE_INFO" }]
